...
class VendorController {
    ...
    static requeryTimedOutTransaction(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.status === false) {
                ...
                if (transactionFailed)
                    yield Transaction_service_1.default.updateSingleTransaction(transactionRecord.id, { status: Transaction_model_1.Status.FAILED });
                else if (transactionIsPending)
                    yield Transaction_service_1.default.updateSingleTransaction(transactionRecord.id, { status: Transaction_model_1.Status.PENDING });
            ...
            yield Transaction_service_1.default.updateSingleTransaction(transactionRecord.id, { status: Transaction_model_1.Status.COMPLETE });
            ...
            transactionRecord = transactionHasBeenAccountedFor ? transactionRecord : yield transactionRecord.update({ amount: transactionRecord.amount, status: Transaction_model_1.Status.COMPLETE });
